# Neural nets and interactive graphs
#
# Problems to be fixed:
#  Missing data, outliers, poor formatting (quotations), data type
# Data - restaurant at a campsite
#  Open the whole year
...
revenue <- read.csv("camping_revenue_97_17.csv", header = F, sep=",", quote = "None")
